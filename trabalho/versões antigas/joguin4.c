...
void * atacante (void * arg) {
    ...
    while (threads_ativas < (A + D) * P) {
        ...
        printf("Thread de ataque do jogador %d liberada!\n", id_jogador);
    }
...
void * defensor (void * arg) {
    ...
    while (threads_ativas < (A + D) * P) {
        //printf("Thread de defesa do jogador %d diz: threads ativas = %d\n", id_jogador, threads_ativas);
        printf("Thread defensora %d do jogador %d BLOQUEADA\n", id_thread, id_jogador);
        pthread_cond_wait(&conds[id_jogador], &mutex);
        printf("Thread de defesa do jogador %d liberada!\n", id_jogador);
    }
